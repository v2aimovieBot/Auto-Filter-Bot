...
# Bot pics
PICS = (environ.get('PICS', 'https://magandi.onrender.com/YNu9.JPG')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '7052947046')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '1002366418239')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '1002261656013')
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+dZkkjEbgGv8wM2Nl')
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/chillxnow")
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/mg_networks')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/mg_network')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+DXazAzf7vM0xN2Fl")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+DXazAzf7vM0xN2Fl")
...
URL = environ.get("URL", "http://federal-ailyn-v2aimoviebotx-028c7545.koyeb.app/")
if len(URL) == 0:
    ...
    if URL.startswith(('https://', 'http://')):
        ...
        URL = f'http://federal-ailyn-v2aimoviebotx-028c7545.koyeb.app/'
    else:
